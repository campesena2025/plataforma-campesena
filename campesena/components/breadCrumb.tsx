...
const Breadcrumbs = ({ titulo }: { titulo: string }) => {
  ...
  const renderBreadcrumbs = () => {
    if (!breadcrumbs) {
      return <div className="h-6 w-64 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />;
    }
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-1 lg:px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex-1">
            <span className="text-lg font-bold tracking-tight text-gray-900 dark:text-white">{titulo}</span>
          </div>
