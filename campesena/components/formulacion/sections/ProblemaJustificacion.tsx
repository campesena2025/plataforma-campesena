...
export const ProblemaJustificacion: React.FC<Props> = ({ data, onChange }) => {
  return (
    <div className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="problema">
        ...
        />
        <div className="mt-2 text-sm text-gray-500">Incluya: situación actual, causas del problema y consecuencias</div>
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="justificacion">
          Justificación *
        </label>
        <textarea
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        />
        <div className="mt-2 text-sm text-gray-500">Incluya: relevancia, oportunidad y viabilidad del proyecto</div>
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="beneficiarios">
          Beneficiarios *
        </label>
        <textarea
          className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      ...
      <div className="bg-green-50 border border-green-200 rounded-md p-4">
        ...
        <div className="text-sm text-green-800 space-y-2">
          <p>
            <strong>Problema identificado:</strong> {data.planteamiento ? '✓ Definido' : '⚠ Pendiente'}
          </p>
          <p>
            <strong>Justificación:</strong> {data.justificacion ? '✓ Completada' : '⚠ Pendiente'}
          </p>
          <p>
            <strong>Beneficiarios:</strong> {data.beneficiarios ? '✓ Identificados' : '⚠ Pendiente'}
          </p>
        </div>
      </div>
    </div>
